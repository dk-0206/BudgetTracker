 ...
 */
// The Thriftly_Tracker class extends JFrame to create the main application window.
public class Thriftly_Tracker extends JFrame {
    
    private final ThriftlyTableModel tableModel;
    ...
    public Thriftly_Tracker(){
        ...
        balance = 0.0;
        tableModel = new ThriftlyTableModel();
    ...
    private void addEntry()
    {
        ...
        ThriftlyEntry entry = new ThriftlyEntry(date, description, amount, type);
